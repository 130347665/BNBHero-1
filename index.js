    ...
    async function getHeros() {
        if (window.chainId == 56) {
            ...
            for (var i = 0; i < heros.length; i++) {
                ...
                html = html + '<div class="progress"><div class="progress-bar" role="progressbar" style="width: 25%;" aria-valuenow="' + heros[i][6] + '" aria-valuemin="0" aria-valuemax="1000">' + heros[i][6] + '/1000</div></div>'
                html = html + '</div></div>'
