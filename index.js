    ...
    async function getHeros() {
        if (window.chainId == 56) {
            ...
            for (var i = 0; i < heros.length; i++) {
                html = html + '<div class="card mh-100"  style="width: 100px; height: 200px; background-color: rgba(0,0,255,0.1);"><div class="card-body" style="width: 230px;background-color:gray;">'
