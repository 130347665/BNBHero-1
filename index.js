    ...
    async function getHeros() {
        if (window.chainId == 56) {
            ...
            for (var i = 0; i < heros.length; i++) {
                ...
                html = html + '<div class="progress"><div class="progress-bar bg-danger text-center" role="progressbar" style="width: ' + heros[i][6]/10 + '%;" aria-valuenow="' + heros[i][6] + '" aria-valuemin="0" aria-valuemax="1000"><p class="text-dark">'  + heros[i][6] + '</p></div></div>'
                html = html + '</div></div>'
